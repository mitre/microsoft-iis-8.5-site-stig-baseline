...
InSpec Profile to validate the secure configuration of Microsoft IIS 8.5 Site against the Microsoft IIS 8.5 Site [STIG](https://iase.disa.mil/stigs/Pages/index.aspx) - Ver 1, Rel 5.
