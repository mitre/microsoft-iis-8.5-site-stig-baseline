...
InSpec Profile to validate the secure configuration of Microsoft IIS 8.5 Site against the [DISA](https://iase.disa.mil/stigs/) Microsoft IIS 8.5 Site Security Technical Implementation Guide (STIG) Version 1, Release 5.
